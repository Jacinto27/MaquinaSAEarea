...
auxiliar_org <- readRDS('...\\Monitoreo y Evaluación\\Proyecto Estimación de Áreas Pequeñas\\Informalidad\\Script2\\Data\\auxiliar_org.Rds')
auxiliar_org$id_municipio <- as.character(auxiliar_org$id_municipio)
d <- left_join(d,(auxiliar_org%>%select('id_municipio','Area_km','ZONA_Rur','Densidad_Pob')), by='id_municipio')
...
saveRDS(object = base_FH, "...\\Monitoreo y Evaluación\\Proyecto Estimación de Áreas Pequeñas\\Informalidad\\Script2\\Data\\base_FH.Rds")
